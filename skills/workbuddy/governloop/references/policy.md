...
Formal rules implemented by `tools/session-manager/governloop_session.py` and
enforced by the GovernLoop Neutral Relay (`neutral_relay.py`). Usage reference:
`docs/USAGE.md`; user guide: `docs/QUICK_START.md`; cross-project isolation:
